            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Software Developer in Calibre Modeling R&D 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am eager to grow and hope to be challenged at Siemens, I do not want an easy graduate program. You will be pleased to hear, I have analyzed data before with Python, have good c++ comprehension, and have developed ML models in TensorFlow. 
                        </Text.P>
                     </Text.Frame>
                  </div>
