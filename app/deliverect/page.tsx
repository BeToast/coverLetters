          ...
          <div className='flex flex-col justify-center h-full'>
            <div className='pc:w-[500px]'>
              ...
              <Text.Frame>
                ...
                <Text.P>
                  I am looking to start my carrer as a frontend developer in the Nederlands and would be delighted to join your team at Deliverect. I am sure you will be pleased with my technical and my interpersonal skills.
                </Text.P>
              </Text.Frame>
            </div>
