            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your next Web Designer/Developer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am interisted in your position, but you use Bootstrap. Bootstrap inhibits innovative design by only allowing you to develop UI with preset options. I hope to join your team and make lasting improvements, like writing a component library to replace bootstrap, as I start my career.
                        </Text.P>
                     </Text.Frame>
                  </div>
