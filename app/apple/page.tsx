            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Large-Scale Developer Tools Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I delight in improving and accelerating tasks. I write bash tools for myself regularly to automate my personal simple tasks, furthermore, I a suitable canidate to write dev tools at Apple.
                        </Text.P>
                     </Text.Frame>
                  </div>
