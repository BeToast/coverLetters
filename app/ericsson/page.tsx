          ...
          <div className='flex flex-col justify-center h-full'>
            <div className='pc:w-[500px]'>
              ...
              <Text.Frame>
                ...
                <Text.P>
                  I am open to working for Ericsson in Athlone or the Nederlands. I would make a positive impact an Ericsson with my technical and my interpersonal skills.
                </Text.P>
              </Text.Frame>
            </div>
