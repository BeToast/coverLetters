          ...
          <div className='flex flex-col justify-center h-full'>
            <div className='pc:w-[500px]'>
              ...
              <Text.Frame>
                ...
                <Text.P>
                  I am eager to begin my career as a software developer and would be delighted to join your team at Rent The Runway, particularly because you use Next.js, my favorite frontend framework.
                </Text.P>
              </Text.Frame>
            </div>
