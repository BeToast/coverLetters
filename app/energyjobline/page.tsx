            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Associate Software Development Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                           Hello Energy Jobline!
                        </Text.Greeting>
                        <Text.P>
                        ...
                        <Text.P>
                           I believe we must transition to renewable energy and I would be happy to work at Energy Jobline as we pursue that goal. I have strong interpersonal skills and am also capable of fufilling the job responsibilities you outlined.
                        </Text.P>
                     </Text.Frame>
                  </div>
