...
export default function Template() {
   const mainId = "genesys-fullstack";
            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Full-Stack<br/>Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am sure you will be pleased with my interpersonal skills alongside proficiency in Python, Java, React, and Jenkins. I hope to join Genesys and be a valuable member of the Work Automation team.
                        </Text.P>
                     </Text.Frame>
                  </div>
