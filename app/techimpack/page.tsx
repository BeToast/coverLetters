            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Front-End Developer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I did NLP research for my bachelors thesis, this shows my passion for data innovation. I hope to join your team and advance your mission to use data for good.
                        </Text.P>
                     </Text.Frame>
                  </div>
