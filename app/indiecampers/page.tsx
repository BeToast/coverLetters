            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Junior Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I would be a good fit for your team as I have a strong grasp on the complete web development process and I am looking for a multiple year commitment. I am a native english speaker and am eligible for IEFP.
                        </Text.P>
                     </Text.Frame>
                  </div>
