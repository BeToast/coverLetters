               ...
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     ...
                     <Text.Frame>
                        ...
                        <Text.P>
                           I am proficient in software development and OOP. Alongside my technical skills, I have strong interpersonal skills and plan to make healthy relationships with colleagues at Oracle.
                        </Text.P>
                     </Text.Frame>
                  </div>
