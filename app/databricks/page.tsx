          ...
          <div className='flex flex-col justify-center h-full'>
            <div className='pc:w-[500px]'>
              ...
              <Text.Frame>
                ...
                <Text.P>
                  I am sure you will be pleased with my technical and my interpersonal skills for this graduate position. I hope to begin my career with you at Databricks.
                </Text.P>
              </Text.Frame>
            </div>
