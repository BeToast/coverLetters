            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Software Engineer (Entry-level) 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I have all the requirements you specified alongside experience with Devops and Agile during my internship at OpenJaw technologies. I would be happy starting my career at Peraton.
                        </Text.P>
                     </Text.Frame>
                  </div>
