            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Front-End Software Engineer Intern 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I, Blake Preston, recently finished my Bachelors in Computer Science and Information Technology at the University of Galway. Since graduating, I applied my knowledge and learned how to develop full-stack web apps with Next.js, React, TypeScript, Tailwindcss and Firebase Hosting. I reccently finished a freelance project as a web developer for Soma Co-working Moycullen. <Text.Link noP={true} href='https://somacowork.ie/'>https://somacowork.ie/</Text.Link>
                        </Text.P>
                        <Text.P>
                           I am enrolled as a PhD student researching NLP, unfortunately due to funding issues, I will not be completing my PhD. I am a passsionate and proficient with Front End technologies and desire to intern at Intuit to secure a permanent position. I guarentee I will be a strong developer for years to come if I am offered an opportunity at Intuit.
                        </Text.P>
                     </Text.Frame>
                  </div>
