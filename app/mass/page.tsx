            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your MDM Junior Programmer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                           Hello Massachusetts Department of Public Health!
                        </Text.Greeting>
                        <Text.P>
                        ...
                        <Text.P>
                           I meet the requirements for your position and would make a meaningful contribution to your data management systems. Database systems was one of my favourite classes I took in college and would passionatly contribute to the improvement to your systems.
                        </Text.P>
                     </Text.Frame>
                  </div>
