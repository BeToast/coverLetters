               ...
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     ...
                     <Text.Frame>
                        ...
                        <Text.P>
                           I meet the requirements for your position and would be happy to start my career at iTalent. I am eager to apply myself and grow rapidly.
                        </Text.P>
                     </Text.Frame>
                  </div>
