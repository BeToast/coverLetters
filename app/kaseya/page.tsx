               ...
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     ...
                     <Text.Frame>
                        ...
                        <Text.P>
                           I have all the qualifications and nice-to-have points you specify in the job description. I have heard good things about Kaseya and would be happy working with you.
                        </Text.P>
                     </Text.Frame>
                  </div>
