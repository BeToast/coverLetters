            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Entry Level Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                           Hello AG Technologies!
                        </Text.Greeting>
                        <Text.P>
                        ...
                        <Text.P>
                           I am a passionate software developer who will make a positive impact at AG Technologies. I am sure you will be pleased with my technical and interpersonal skills. I look forward to pushing quality code at AG Technologies.
                        </Text.P>
                     </Text.Frame>
                  </div>
