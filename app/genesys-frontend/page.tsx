            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Frontend<br/>Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I, Blake Preston, recently finished my studies in Computer Science and Information Technology at the University of Galway. Since graduating, I applied my knowledge and learned how to develop full-stack web apps with Next.js, React, TypeScript, Tailwindcss and Firebase Hosting. I reccently finished a freelance project as a web developer for Soma Co-working Moycullen. <Text.Link noP={true} href='https://somacowork.ie/'>https://somacowork.ie/</Text.Link> Currenly, I am working on a church website template which statically generates routes and pages from markdown files using Next.js, Tailwindcss, TypeScript, and Google Firebase.
                        </Text.P>
                        <Text.P>
                           I am sure you will be pleased with my interpersonal skills alongside proficiency in DOM, CSS, TypeScript, React, Webpack, and Github. I hope to join Genesys and be a valuable member of the Sendero Messaging team.
                        </Text.P>
                     </Text.Frame>
                  </div>
