            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Early Career, Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           Just last month, I properly learned cpp from <Text.Link noP={true} href='https://www.learncpp.com/'>learncpp.com</Text.Link> and would like to work with c++. The lower-level control avilable in splendid compared to Java or Python. I am a strong problem solver who delights in learning new technologies. I'm sure you will be satisified me as your next software developer.
                        </Text.P>
                     </Text.Frame>
                  </div>
