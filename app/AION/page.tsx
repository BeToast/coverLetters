               ...
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     ...
                     <Text.Frame>
                        ...
                        <Text.P>
                           I want to begin my career at an innovative company like AION. I am best suited as a web developer, however, I have also had sucess with deep neural networks for NLP. Due to my adaptablity, I would be able to contribute to various software projects to fufill your buisness opjectives.
                        </Text.P>
                     </Text.Frame>
                  </div>
                  <div className='flex flex-wrap pc:w-[500px] items-end justify-between pt-12 pb-1'>
                     ...
                     <div className='mt-12'>
                        <Signature>
                           I hope to start a career with you,
                        </Signature>
                     </div>   
                  </div>
               </div>
