            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your next New Grad 2024 | Software Engineer | Frontend 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am eager to begin my career because of my passion for frontend development. I love knowing my components will be used to improve the UX of individuals using the website. I would be a strong addition to your team at Ramp with my strong technical and interpersonal skills.
                        </Text.P>
                     </Text.Frame>
                  </div>
