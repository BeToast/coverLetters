            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Associate, Software Engineer, Build & Release 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           Over the past two years, I have learned to love linux, bash and Python. I am a well-rounded programmer and will be able to perform tasks in many other languages. I am sure you will be pleased with my technical and interpersonal skills.
                        </Text.P>
                     </Text.Frame>
                  </div>
