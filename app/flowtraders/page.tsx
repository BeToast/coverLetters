          ...
          <div className='flex flex-col justify-center h-full'>
            <div className='pc:w-[500px]'>
              ...
              <Text.Frame>
                ...
                <Text.P>
                  Although my experience is with Web Tecnhologies, I would like to pivot to something more challenging like C++ or Rust. I am sure you will be pleased with my technical and my interpersonal skills for this graduate position.
                </Text.P>
              </Text.Frame>
            </div>
