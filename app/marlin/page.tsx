            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Software Developer - React 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                           Hello Marlin Alliance!
                        </Text.Greeting>
                        <Text.P>
                        ...
                        <Text.P>
                           I am a passionate software developer who has all the job requirements you specified. I am sure you will be pleased with my technical and interpersonal skills. I am looking forward to pushing quality code at The Marlin Alliance.
                        </Text.P>
                     </Text.Frame>
                  </div>
