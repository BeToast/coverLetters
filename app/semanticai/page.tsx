            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Software Engineer - Part-time 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am a passionate software developer who believes in test-driven development. I am looking forward to writing robust Typescript tests on your QA team. Additionally, I am sure you will be pleased with my interpersonal skills.
                        </Text.P>
                     </Text.Frame>
                  </div>
