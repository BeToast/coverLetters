            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Software Applications Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I would be able to perform all the responsibilities you outline in the job description. I am sure you will be satisfied with me in this role.
                        </Text.P>
                     </Text.Frame>
                  </div>
