          ...
          <div className='flex flex-col justify-center h-full'>
            <div className='pc:w-[500px]'>
              ...
              <Text.Frame>
                ...
                <Text.P>
                  I am looking to start my carrer using Next.js and would be delighted to join your team at Intercom. I am sure you will be pleased with my technical and my interpersonal skills.
                </Text.P>
              </Text.Frame>
            </div>
