               ...
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     ...
                     <Text.Frame>
                        ...
                        <Text.P>
                           I was a graphic design intern at CVstrat in highschool(Marcos taught me many things!). During my summer with you, I enjoyed your company vibe and would fit culture well.
                        </Text.P>
                     </Text.Frame>
                  </div>
