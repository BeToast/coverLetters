            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Frontend Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I enjoy Web Development and inted to make an impact throughout my career. I am sure you will be pleased with my technical and interpersonal skills. I am looking forward to pushing quality code at BigML.
                        </Text.P>
                     </Text.Frame>
                  </div>
