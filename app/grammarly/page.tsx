            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Software Engineer, Front-End (Retain and Expand) 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am very interisted in this position because my work will be 'highly impactful and visible' forcing me to rise to challenges and grow rapidly. I am EAGER and hope to contribute to the future of Grammarly. This coverletter was corrected with Grammarly 😂
                        </Text.P>
                     </Text.Frame>
                  </div>
