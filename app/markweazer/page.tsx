            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        I'm looking for a junior software developmer position.
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I would be best suited as a front-end developer, however I am also interisted in CI pipelines and devops. I am adventurous and open to relocating to various countries; maybe we will meet in Singapore!
                        </Text.P>
                     </Text.Frame>
                  </div>
