            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Associate Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am a young energetic self-starter who desires to develop robust quality software. I would make a meaningful contribution to Veeva
                        </Text.P>
                     </Text.Frame>
                  </div>
