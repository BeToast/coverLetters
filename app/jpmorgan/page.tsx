            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Associate Production Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am a passionate software developer looking to make an impact throughout my career. I am sure you will be please with my technical and interpersonal skills. Wether I am in data anlytics or software engineering I will be happy to contrribute to the future at JP Morgan.
                        </Text.P>
                     </Text.Frame>
                  </div>
