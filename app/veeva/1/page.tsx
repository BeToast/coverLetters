            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Associate DevOps Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I have experience with an auto-test suite and CI pipeline in Jenkins. I also have work experience with Atlassian products. Personally, I delight in innovating tasks and reducing recurring work which I would be able to do in DevOps.
                        </Text.P>
                     </Text.Frame>
                  </div>
