            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your next Entry Level Application Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I am a passionate software developer looking to make an impact throughout my career. I am sure you will be pleased with my technical and interpersonal skills. I am looking forward to pushing quality code at Vanguard.
                        </Text.P>
                     </Text.Frame>
                  </div>
