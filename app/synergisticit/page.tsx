            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Entry-Level Programmer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                           Hello Synergistic IT!
                        </Text.Greeting>
                        <Text.P>
                        ...
                        <Text.P>
                           I am passionate about software development and will make a positive impact during my career, regardless the company. I am sure you will be pleased with my well-rounded technical skills alongside my strong interpersonal skills.
                        </Text.P>
                     </Text.Frame>
                  </div>
