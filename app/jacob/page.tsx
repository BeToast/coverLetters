               ...
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     ...
                     <Text.Frame>
                        ...
                        <Text.P>
                           I have my preferred webstack, however, I delight in learning new languages and technologies. If a opportunity arises at Commerce7 which is not in my wheelhouse I would love to be challenged working with a technology I am not proficient in.
                        </Text.P>
                     </Text.Frame>
                  </div>
