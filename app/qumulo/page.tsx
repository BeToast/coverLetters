            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet you new Software Development Engineer: Entry-Level 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           If you are looking for a sharp developer with high potential, I am your guy. I can write Python, C, and I excited to learn Rust because I forecase it will be dominate language in a decade. Thank you for your time!
                        </Text.P>
                     </Text.Frame>
                  </div>
