            ...
            <AppearAffect>
               <div className='flex flex-col justify-center h-full'>
                  <div className='pc:w-[500px]'>
                     <Title>
                        Meet your new Software Engineer 😉
                     </Title>
                     <Hr className='my-6' />
                     <Text.Frame>
                        <Text.Greeting>
                        ...
                        <Text.P>
                           I would be a good fit for this role and have everything you specified in the "what we're looking for" section. I have not written Swift in a few years, however I assure you I am competent enough to program on the team immediately.
                        </Text.P>
                     </Text.Frame>
                  </div>
